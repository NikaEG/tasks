...
while A == True:
  ...
  if choice1 == "A":
    ...
    time.sleep(2)
    print("Maybe I can assist? I have a number of tasks I need to be completed, but the last few people who said yes still have not returned, I'm afraid!")
  elif choice1 == "C":
